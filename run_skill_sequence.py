...
def exec_and_record(environment_name: str, skill_sequence_fpath: str, args, **kwargs):
    ...
    skill_sequence = load_from_file(skill_sequence_fpath)
    # Run skill sequence
...
if __name__ == "__main__":
    ...
    parser.add_argument("skill_sequence_fpath", type=str, default="task_config/burger_skill_sequence.yaml", help="Path to the skill sequence YAML file.")
    parser.add_argument("save_path", type=str, default="test_run/burger/", help="Path to save the execution results.")
